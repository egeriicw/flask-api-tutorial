...
from flask_restx.fields import String, Boolean, DateTime, Integer, List, Nested, Url
...
pagination_parser.add_argument("per_page", type=positive, required=False,
                               choices=choices, default=10)
