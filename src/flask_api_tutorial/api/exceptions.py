"""Custom HTTPExceptions classes that extend werkzeug exceptions."""

from werkzeug.exceptions import Unauthorized, Forbidden

_REALM_REGULAR_USERS = "registered_user@domain.com"
_REALM_ADMIN_USERS = "admin_users@domain.com"
...
class ApiForbidden(Forbidden):
    """Rase status code 403 with customizable WWW-Authenticate header"""
