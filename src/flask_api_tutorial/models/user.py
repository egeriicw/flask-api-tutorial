...
class User(db.Model):
    """User modle for storing login credentials"""

    # User is a subclass of db.Model. Subclasing db.Model "registers" the model
    # with SQLAlchemy, allowing the ORM to create a database table based on the column
    # definitions outlined in the model.

    # def __init__(self, **kwargs):
    #     super(User, self).__init__(**kwargs)
    #     #add any customer initializtion/construction code here.

    __tablename__ = "site_user"

    # Becuase SQLAlchemy converts the model name to lower case. Since 'user'
    # has a specific definition in Flask, we define an alternative by setting
    # __tablename__ to 'site_user'
